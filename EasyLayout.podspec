#
#  Be sure to run `pod spec lint EasyLayout.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Blake Tsuzaki"
  # s.authors            = { "Blake Tsuzaki" => "dtsuzaki@scu.edu" }
  # s.social_media_url   = "http://twitter.com/Blake Tsuzaki"
